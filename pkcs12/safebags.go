...
func decodePkcs8ShroudedKeyBag(asn1Data, password []byte) (privateKey interface{}, err error) {
	...
	if err = unmarshal(asn1Data, pkinfo); err != nil {
		return nil, errors.New("go-pkcs12: error decoding PKCS#8 shrouded key bag: " + err.Error())
	}

	pkData, err := pbDecrypt(pkinfo, password)
	if err != nil {
		return nil, errors.New("go-pkcs12: error decrypting PKCS#8 shrouded key bag: " + err.Error())
	}

	ret := new(asn1.RawValue)
	if err = unmarshal(pkData, ret); err != nil {
		return nil, errors.New("go-pkcs12: error unmarshaling decrypted private key: " + err.Error())
	}

	if privateKey, err = ParsePKCS8PrivateKey(pkData); err != nil {
		return nil, errors.New("go-pkcs12: error parsing PKCS#8 private key: " + err.Error())
	}
...
func encodePkcs8ShroudedKeyBag(privateKey interface{}, password []byte) (asn1Data []byte, err error) {
	...
	if _, err = rand.Read(randomSalt); err != nil {
		return nil, errors.New("go-pkcs12: error reading random salt: " + err.Error())
	}
	var paramBytes []byte
	if paramBytes, err = asn1.Marshal(pbeParams{Salt: randomSalt, Iterations: 2048}); err != nil {
		return nil, errors.New("go-pkcs12: error encoding params: " + err.Error())
	}
	...
	if err = pbEncrypt(&pkinfo, pkData, password); err != nil {
		return nil, errors.New("go-pkcs12: error encrypting PKCS#8 shrouded key bag: " + err.Error())
	}

	if asn1Data, err = asn1.Marshal(pkinfo); err != nil {
		return nil, errors.New("go-pkcs12: error encoding PKCS#8 shrouded key bag: " + err.Error())
	}
...
func decodeCertBag(asn1Data []byte) (x509Certificates []byte, err error) {
	...
	if err := unmarshal(asn1Data, bag); err != nil {
		return nil, errors.New("go-pkcs12: error decoding cert bag: " + err.Error())
	}
...
func encodeCertBag(x509Certificates []byte) (asn1Data []byte, err error) {
	...
	if asn1Data, err = asn1.Marshal(bag); err != nil {
		return nil, errors.New("go-pkcs12: error encoding cert bag: " + err.Error())
	}
	return asn1Data, nil
}
